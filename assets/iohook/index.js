...
// const essential =
//   'electron-v' + '87' + '-' + process.platform + '-' + process.arch;

const essential = 'electron-v87-win32-x64';

let templateFilePath =
  'D:\\project\\earth-electron\\release\\build\\win-unpacked\\resources\\assets';
// 获取不打包的静态资源路径 只能使用process.cwd 不能使用 app.getAppPath
// if (app.isPackaged) {
//   templateFilePath = path.join(process.cwd(), '/resources/assets');
// } else {
//   templateFilePath = path.join(process.cwd(), '/assets');
// }
...
// }
let NodeHookAddon = require('./electron-v87-win32-x64/build/Release/iohook.node');
